...
GPIO.setmode(GPIO.BCM)  
    ...
    # GPIO 23 & 16 set up as inputs, pulled up to avoid false detection.  
...
print ("it will connect GPIO port 16 (pin 11) to GND (pin 14)"  )
input("Press Enter when ready\n>")  
      
    # when a falling edge is detected on port 16, regardless of whatever   
